...
for num in range(start_num, end_num + 1):
    ...
    if dig1 <= dig2 and dig2 <= dig3 and dig3 <= dig4 and dig4 <= dig5 and dig5 <= dig6:
        if dig1 == dig2 and dig2 != dig3:
            flag = 1
        elif dig1 != dig2 and dig2 == dig3 and dig3 != dig4:
            flag = 1
        elif dig2 != dig3 and dig3 == dig4 and dig4 != dig5:
            flag = 1
        elif dig3 != dig4 and dig4 == dig5 and dig5 != dig6:
            flag = 1
        elif dig4 != dig5 and dig5 == dig6:
            flag = 1
        else:
            flag = 0
